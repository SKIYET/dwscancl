...
wget --append-output=updatelog.txt --no-verbose -N --no-if-modified-since --header "Host: update.geo.drweb.com" --header "User-Agent: DrWebUpdate-12.0.56.02100 (windows: 6.1.7601)" --header "Accept: */*" --header "X-DrWeb-KeyNumber: 0153665829" --header "X-DrWeb-Validate: 26bf3ccf1b26691a44b8ddfb41a0e901" --header "X-DrWeb-SysHash: C7B5A8334AF24F3CF842371701E76DD1" --header "Cache-Control: no-cache" --header "Pragma: no-cache" --header "Connection: Keep-Alive" --no-cookies -P baserepo -i dl1250exe
